...
const sections: Section[] = [
  ...
  {
    title: "9. Future utility and monetization",
    status: "Planned",
  ...
  {
    title: "10. Privacy and responsible AI",
    status: "Live",
  ...
  {
    title: "11. Risks and open questions",
    status: "Strategy",
