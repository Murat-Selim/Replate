...
const capabilities: Capability[] = [
  { id: "advancedReceipt", name: "Advanced Receipt Intelligence", method: "POST", path: "/api/intelligence/advanced", description: "Generate a replay-verifiable report bound to the verified receipt, line items, scores, and rule versions.", price: INTELLIGENCE_PRICING.advancedReceipt, status: "live", input: [
